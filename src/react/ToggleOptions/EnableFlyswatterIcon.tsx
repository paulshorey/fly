...
export const Button: React.FC<PropsTypes> = ({ options = {} }) => {
  ...
  return (
    <div className="buttonContainer">
      <button className="snowButton" onClick={() => { onClick('HIDE_POPUPS_AND_ADS') }}>
        {options.HIDE_POPUPS_AND_ADS ? "Remove annoying popups and ads" : "Ignore (ok to show) popups and ads"}
      </button>
